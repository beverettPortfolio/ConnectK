...
public class EvaluatorTest extends AITest {
	...
	public static TestSuite suite() {
		...
		testSuite.addTest(new EvaluatorTest("Center", new byte[][] { { 0, 0, 0 }, { 0, 1, 0 }, { 0, 0, 0 } }, 3, false, 40));
		testSuite.addTest(new EvaluatorTest("1 Corner 2 Center", new byte[][] { { 1, 0, 0 }, { 0, 2, 0 }, { 0, 0, 0 } }, 3, false, -10));
